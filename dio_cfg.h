...
{
  /* TODO: Populate this list based on available MCU pins */ 
  PA0 = PORTA * DIO_CHANNELS_PER_PORT, PA1, PA2, PA3, PA4, PA5, PA6, PA7,
  PB0 = PORTB * DIO_CHANNELS_PER_PORT, PB1, PB2, PB3, PB4, PB5, 
  PC0 = PORTC * DIO_CHANNELS_PER_PORT, PC1, PC2, PC3, PC4, PC5, PC6, PC7,
  PD0 = PORTD * DIO_CHANNELS_PER_PORT, PD1, PD2, PD3, PD4, PD5, PD6, PD7,
  PE0 = PORTE * DIO_CHANNELS_PER_PORT, PE1, PE2, PE3, PE4, PE5,
  PF0 = PORTF * DIO_CHANNELS_PER_PORT, PF1, PF2, PF3, PF4, 
  PG0 = PORTG * DIO_CHANNELS_PER_PORT, PG1,
  PH0 = PORTH * DIO_CHANNELS_PER_PORT, PH1, PH2, PH3,
  PJ0 = PORTJ * DIO_CHANNELS_PER_PORT, PJ1,
  PK0 = PORTK * DIO_CHANNELS_PER_PORT, PK1, PK2, PK3, PK4, PK5, PK6, PK7,
  PL0 = PORTL * DIO_CHANNELS_PER_PORT, PL1, PL2, PL3, PL4, PL5, PL6, PL7,
  PM0 = PORTM * DIO_CHANNELS_PER_PORT, PM1, PM2, PM3, PM4, PM5, PM6, PM7,
  PN0 = PORTN * DIO_CHANNELS_PER_PORT, PN1, PN2, PN3, PN4, PN5,
  PP0 = PORTP * DIO_CHANNELS_PER_PORT, PP1, PP2, PP3, PP4, PP5,
  PQ0 = PORTQ * DIO_CHANNELS_PER_PORT, PQ1, PQ2, PQ3, PQ4,
  DIO_CHANNEL_MAX
}DioChannel_t;
